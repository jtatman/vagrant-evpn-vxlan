Vagrant.configure(2) do |config|
  ...
  config.vm.box = 'aravind/xenial-lxc-amd64'
  ...
  config.vm.define :gobgp2 do |gobgp2|
    ...
    # outer network
    gobgp2.vm.network "private_network", ip: "10.0.12.20", netmask: "255.255.255.0", lxc__bridge_name: 'vlxcbr1'
    gobgp2.vm.network "private_network", ip: "10.0.23.20", netmask: "255.255.255.0", lxc__bridge_name: 'vlxcbr1'
    # basic setup
  ...
  config.vm.define :gobgp3 do |gobgp3|
    ...
    # outer network
    gobgp3.vm.network "private_network", ip: "10.0.23.10", netmask: "255.255.255.0", lxc__bridge_name: 'vlxcbr1'
    # basic setup
